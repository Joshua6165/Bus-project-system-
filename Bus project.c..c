...
#include <stdlib.h>
#include <string.h>
char ch[13][120]={"London Express","Newcastle Express","Master Express","Harvard Express","Newcity Express","Modern Express"};
char name[30][110]={'\0'};
char number[30][3]={'\0'};
int num1[30]={0};
int trno;
void bus();//for list of bus
void name_number(int booking,char numstr[110]);
...
void name_number(int booking,char numstr[110])
{
char tempstr[110],tempstr1[13]="status",tempstr2[13]="number";
int number;
    FILE *a,*b;
    int i=0;
   strcat(numstr,".txt");
...
{
char tempstr[110],tempstr2[13]="number";
FILE *a,*b;
char numstr[110];
int i=0,j=0,k;
itoa(trno,numstr,13);
...
printf("=========================================== BUS RESERVATION SYSTEM ============================================\n\n\n");
    ...
    printf("                                      Bus.no-->%d---->%s                                                            \n",trno,ch[trno-1]);
    printf("____________________________________________________________________________________________________________________\n");
    char tempname[30][13]={"Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty ","Empty "};
    for(i=0; i<j; i++)
    {
...
{
 int seat_no,i,j;
 char numstr[110],tempstr2[18]="number",tempstr1[18]="status";
 printf("Enter the bus number:---->");
 scanf("%d",&trno);
 itoa(trno,numstr,13);
 strcat(numstr,".txt");
...
printf("\n\n");
    printf("======================================================================================================\n");
 printf("\t\t\t\tYour 500 rupees has been Returned\t\t\t\n");
    printf("======================================================================================================\n");
}
...
i=0;
//scanf("%s",&p_word);
if(strcmp(u_name,"michael")==0 && strcmp(p_word,"michael")==0)
{
